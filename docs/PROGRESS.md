...
## Last Updated
2026-04-07 — Three-hop path closed. Text-derived microbe→feature CORRELATES_WITH edges connect 3 microbes to features with downstream disease edges, yielding 62 end-to-end Microbe→Feature→Disease paths.
