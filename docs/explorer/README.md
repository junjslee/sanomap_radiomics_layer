...
> Note: this explorer currently reads a frozen 2026-04-05 JSONL snapshot
> (`data.jsonl`, 185 rows), not the canonical `artifacts/graph_export/`
> bundle. Rewiring it onto the current export (or live Neo4j via
> `src/graph_queries.py`) is tracked as open application work in
> `docs/PLAN.md`.
